// Hooks
{
	...
	::DynamicSpawns.Public.getUnit("Unit.RF.Knight").StartingResourceMin = 500;		// Reforged: 350
	::DynamicSpawns.Public.getUnit("Unit.RF.RF_KnightAnointed").StartingResourceMin = 700;		// Reforged: 450

	// We enforce a higher base resource value some nobles to make them appear later
	::DynamicSpawns.Public.getUnit("Unit.RF.RF_Marshal").StartingResourceMin = 400;		// Reforged: 350
	::DynamicSpawns.Public.getUnit("Unit.RF.RF_Herald").StartingResourceMin = 500;		// Reforged: 350
}
