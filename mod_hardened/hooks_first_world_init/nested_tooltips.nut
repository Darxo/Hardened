...
::MSU.Table.merge(::Reforged.NestedTooltips.Tooltips.Concept, {
	...
	CriticalDamage = ::MSU.Class.BasicTooltip("Critical Damage", ::Reforged.Mod.Tooltips.parseString("Critical Damage refers to bonus Hitpoint Damage inflicted when striking specific body parts. This damage is applied after armor mitigation.\n\nBy default, hits to the head deal " + ::MSU.Text.colorPositive("+50%") + " additional critical damage.")),
