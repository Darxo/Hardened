::Hardened.HooksMod.hook("scripts/entity/world/attached_location/stone_watchtower_location", function(q) {
	...
	q.create = @(__original) function()
	{
		...
		// Defender
		this.m.Resources = 200 * ::Hardened.Global.FactionDifficulty.Nobles;
	...
	q.onDropLootForPlayer = @(__original) function( _lootTable )
	{
		...
		this.HD_dropFood(::Math.rand(2, 4), [
			"bread_item",
			"beer_item",
			"dried_fruits_item",
			"ground_grains_item",
