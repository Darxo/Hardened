::Hardened.HooksMod.hook("scripts/entity/world/attached_location/fortified_outpost_location", function(q) {
	...
	q.create = @(__original) function()
	{
		...
		// Defender
		this.m.Resources = 250 * ::Hardened.Global.FactionDifficulty.Nobles;
	...
	{
		__original(_in);
		if (this.m.Resources == 0) this.m.Resources = 350;
	}
});
