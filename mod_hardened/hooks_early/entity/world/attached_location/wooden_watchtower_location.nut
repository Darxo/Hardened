::Hardened.HooksMod.hook("scripts/entity/world/attached_location/wooden_watchtower_location", function(q) {
	...
	q.create = @(__original) function()
	{
		...
		this.m.CombatLocation.AdditionalRadius = 0;

		// Defender
		this.m.Resources = 150 * ::Hardened.Global.FactionDifficulty.Nobles;
	...
	q.onDropLootForPlayer = @(__original) function( _lootTable )
	{
		...
		this.HD_dropFood(::Math.rand(1, 3), [
			"bread_item",
			"beer_item",
			"dried_fruits_item",
			"ground_grains_item",
	...
	{
		__original(_in);
		if (this.m.Resources == 0) this.m.Resources = 210;
	}
});
