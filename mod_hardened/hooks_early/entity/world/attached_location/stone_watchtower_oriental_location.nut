::Hardened.HooksMod.hook("scripts/entity/world/attached_location/stone_watchtower_oriental_location", function(q) {
	...
	q.create = @(__original) function()
	{
		...
		// Defender
		this.m.Resources = 200 * ::Hardened.Global.FactionDifficulty.CityState;
