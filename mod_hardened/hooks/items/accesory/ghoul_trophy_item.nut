::Hardened.HooksMod.hook("scripts/items/accessory/ghoul_trophy_item", function(q) {
	...
	q.getTooltip = @(__original) function()
	{
		...
		ret.push({
			...
			text = ::MSU.Text.colorizeMultWithText(this.m.HD_SkillValueMult, {InvertColor = true}) + ::Reforged.Mod.Tooltips.parseString(" likely to be targeted with [$ $|Skill+ghoul_claws] or [$ $|Skill+swallow_whole_skill]"),
		});
