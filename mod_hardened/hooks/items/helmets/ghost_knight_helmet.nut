::Hardened.HooksMod.hook("scripts/items/helmets/ghost_knight_helmet", function(q) {
	...
	q.create = @(__original) function()
	{
		...
		this.m.Name = "Rachegeist\'s Full Helm";	// Vanilla: Rachegeist\'s Helm
		this.m.StaminaModifier = -23;	// Vanilla: -18
	}
