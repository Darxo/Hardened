::Hardened.HooksMod.hook("scripts/skills/actives/rf_cover_ally_skill", function(q) {
	...
	q.getTooltip = @() function()
	{
		...
		ret.push({
			...
			text = ::Reforged.Mod.Tooltips.parseString("Is removed when you get [$ $|Concept.Stunned], start [fleeing|Skill+hd_dummy_morale_state_fleeing] or move away from your target"),
		});
