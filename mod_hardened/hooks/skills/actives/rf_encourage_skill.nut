::Hardened.HooksMod.hook("scripts/skills/actives/rf_encourage_skill", function(q) {
	...
	{
		__original();
		this.m.Description = ::Reforged.Mod.Tooltips.parseString("Encourage an ally from your faction to raise their current [Morale|Concept.Morale]. Cannot be used on [fleeing|Skill+hd_dummy_morale_state_fleeing], [steady|Concept.Morale] or [Stunned|Concept.Stunned] allies.");
	}
