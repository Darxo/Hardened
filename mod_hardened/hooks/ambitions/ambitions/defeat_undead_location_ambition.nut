::Hardened.HooksMod.hook("scripts/ambitions/ambitions/defeat_undead_location_ambition", function(q) {
	...
	q.getButtonTooltip = @(__original) { function getButtonTooltip()
	{
		...
		this.m.HD_TempNestedItem = ::new("scripts/items/accessory/undead_trophy_item");
		ret.push({
			id = 10,
			type = "text",
