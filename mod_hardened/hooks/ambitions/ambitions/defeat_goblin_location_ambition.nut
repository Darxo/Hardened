::Hardened.HooksMod.hook("scripts/ambitions/ambitions/defeat_goblin_location_ambition", function(q) {
	...
	q.getButtonTooltip = @(__original) { function getButtonTooltip()
	{
		...
		this.m.HD_TempNestedItem = ::new("scripts/items/accessory/goblin_trophy_item");
		ret.push({
			id = 10,
			type = "text",
