...
// Hardened Functions
	...
	q.HD_assignArmor <- function()
	{
		...
		this.getItems().equip(::new("scripts/items/armor/greenskins/goblin_shaman_armor"));
		this.getItems().equip(::new("scripts/items/helmets/greenskins/goblin_shaman_helmet"));
	}
});
