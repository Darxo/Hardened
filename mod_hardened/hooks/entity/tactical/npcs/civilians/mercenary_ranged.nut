...
// New Functions
	...
	q.HD_assignArmor <- function()
	{
		...
		if (r == 1) this.m.Items.equip(this.new("scripts/items/armor/thick_tunic"));
		else if (r == 2) this.m.Items.equip(this.new("scripts/items/armor/padded_surcoat"));
		else if (r == 3) this.m.Items.equip(this.new("scripts/items/armor/basic_mail_shirt"));
		else if (r == 4) this.m.Items.equip(this.new("scripts/items/armor/mail_shirt"));
		else if (r == 5) this.m.Items.equip(this.new("scripts/items/armor/ragged_surcoat"));
		else if (r == 6) this.m.Items.equip(this.new("scripts/items/armor/padded_leather"));
