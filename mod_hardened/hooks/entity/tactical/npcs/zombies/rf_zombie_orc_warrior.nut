::Hardened.HooksMod.hook("scripts/entity/tactical/enemies/rf_zombie_orc_warrior", function(q) {
	q.create = @(__original) function()
	{
		...
		local orcArmory = ::new("scripts/entity/tactical/enemies/orc_warrior");
