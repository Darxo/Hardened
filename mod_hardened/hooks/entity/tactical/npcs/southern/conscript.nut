...
// New Functions
	...
	q.HD_assignArmor <- function()
	{
		...
		{
			this.getItems().equip(::new("scripts/items/helmets/oriental/wrapped_southern_helmet"));
		}
		else if (r == 3)
		{
			this.getItems().equip(::new("scripts/items/helmets/oriental/spiked_skull_cap_with_mail"));
		}
	}
});
