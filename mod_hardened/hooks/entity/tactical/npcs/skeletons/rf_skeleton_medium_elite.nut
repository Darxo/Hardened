...
::Hardened.HooksMod.hook("scripts/entity/tactical/enemies/rf_skeleton_medium_elite", function(q) {	// Ancient Palatinus
	q.create = @(__original) function()
	{
		__original();

		this.m.ChestWeightedContainer = ::MSU.Class.WeightedContainer([
			[12, "scripts/items/armor/ancient/ancient_scale_coat"],
			[12, "scripts/items/armor/ancient/ancient_plated_mail_hauberk"],
		]);
