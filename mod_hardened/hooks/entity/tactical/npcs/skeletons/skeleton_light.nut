...
::Hardened.HooksMod.hook("scripts/entity/tactical/enemies/skeleton_light", function(q) {	// Ancient Auxiliary
	q.create = @(__original) function()
	{
		...
		this.m.HelmetConditionRoll = ::MSU.Class.WeightedContainer([
			[12, 0.8],
			[12, 1.0],
		]);
	}
